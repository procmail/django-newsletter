...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.name_field'
        db.alter_column(u'newsletter_subscription', 'name', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, db_column='name'))

    def backwards(self, orm):

        # Changing field 'Subscription.name_field'
        db.alter_column(u'newsletter_subscription', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_column='name'))
    ...
    models = {
        ...
        u'newsletter.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'to': u"orm['newsletter.Newsletter']"}),
        ...
        u'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'6cab245549c10aaaa6b0426d3ef7d5c46a2653a4'", 'max_length': '40'}),
