...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.tag'
        db.add_column(u'newsletter_article', 'tag',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.tag'
        db.delete_column(u'newsletter_article', 'tag')
    ...
    models = {
        ...
        u'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 16, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'bc23c761e9867643db11a6952e89a2e426dfb6a0'", 'max_length': '40'}),
